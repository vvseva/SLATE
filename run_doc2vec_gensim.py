...
train_corpus = list(read_corpus("/students/vvsuschevskiy/SLATE/syllabus_full.txt"))
test_corpus = list(read_corpus("/students/vvsuschevskiy/SLATE/syllabus_full.txt", tokens_only=True))
#%%
###############################################################################
...
#
#%%
model = gensim.models.doc2vec.Doc2Vec(vector_size=52, min_count=2, epochs=48)
...
#
#%%
vector = model.infer_vector(['I', 'want', 'to', 'master', 'modeling', 'skills'])
print(vector)
...
print('Second Similar Document {}: «{}»\n'.format(sim_id2, ' '.join(train_corpus[sim_id2[0]].words)))
